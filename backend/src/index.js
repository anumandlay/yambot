...
app.use("/api/triggers", authRequired, (await import("./routes/triggers.js")).triggersRouter);
  ...
  app.use("/api/proofs", authRequired, (await import("./routes/proofs.js")).proofsRouter);
...
app.use("/api/company-dashboard", authRequired, (await import("./routes/companyDashboard.js")).companyDashboardRouter);
app.use("/api/campaigns", authRequired, (await import("./routes/campaigns.js")).campaignsRouter);
app.use("/api/tickets", authRequired, (await import("./routes/tickets.js")).ticketsRouter);
app.use("/api/documents", authRequired, (await import("./routes/documents.js")).documentsRouter);
app.use("/api/queues", authRequired, (await import("./routes/queues.js")).queuesRouter);
app.use("/api/deals", authRequired, (await import("./routes/deals.js")).dealsRouter);
app.use("/api/invoices", authRequired, (await import("./routes/invoices.js")).invoicesRouter);
app.use("/api/teams", authRequired, (await import("./routes/teams.js")).teamsRouter);
app.use("/api/audit", authRequired, (await import("./routes/auditExport.js")).auditRouter);
app.use("/api/portal", (await import("./routes/portal.js")).portalRouter);
