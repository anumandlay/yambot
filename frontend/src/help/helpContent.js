...
export const HELP = {
  ...
  "agent.group": {
    ...
    body: helpBody(
      ...
      "Also the territory for Company leads and tickets: agents in the same group share that database. Import leads from Company → Entities."
    ),
  },
  "agent.description": {
  ...
  "agent.memory": {
    ...
    body: helpBody(
      "Curated MEMORY (Hermes-style) holds durable agent notes with a 20,000 character cap. At task start YamBot injects the top facts relevant to the goal (semantic embeddings when your LLM supports /embeddings; otherwise keyword match). Account USER prefs live under Settings → Memory.",
  ...
  "chat.teachSkill": {
    title: "Teach skill",
    body: helpBody(
      "Pauses the agent and records your clicks/typing via a Chrome extension inside the cloud browser (labels, css, xpath — not just screen %).",
      "Perform the workflow in the remote desktop, click Done teaching — a draft skill is saved. Promote to production + replay to reuse."
    ),
  },
  "chat.zoomChat": {
    title: "Chat in zoom",
