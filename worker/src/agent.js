        ...
        const messages = [
          {
            ...
            content: [
              ...
              "CONDITIONS: If the goal or ACTIVE USER MESSAGE contains an if/then rule, evaluate THAT rule only. SITE MEMORY and older chat summaries may mention different thresholds — ignore those; do not reuse a prior condition.",
