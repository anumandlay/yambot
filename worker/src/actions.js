...
- message_agent: { "type":"message_agent", "to":"Exact Peer Name", "mode":"task|question|approval|handoff|event", "content":"...", "wait": true } — ask another agent. Modes: task/question/approval/handoff/event. wait defaults true except event. Max hop depth 2 (A→B→C). Managers may only message managedAgents when that list is set. When the goal is “have peer open a site / do work and report back”, emit ONLY message_agent (then finish with their result) — do not navigate that URL yourself.
